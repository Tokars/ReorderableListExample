...
public class EditorLevelRecords : Editor
{
    private SerializedProperty m_lvlData;
    private ReorderableList m_ReorderableList;

        private void OnEnable()
    {
        //Find the list in our ScriptableObject script.
        m_lvlData = serializedObject.FindProperty("levels");

        //Create an instance of our reorderable list.
        m_ReorderableList = new ReorderableList(serializedObject: serializedObject, elements: m_lvlData, draggable: true, displayHeader: true,
